...
ppath='/Users/adam/work/sgrb2/alma/SgrB2_CFE'
paper_name = 'cfe'
...
# \e became a special character in python3.6?
...
os.system('tar --exclude Makefile -czf Ginsburg_SgrB2_00269_cores_%s_%s.tar.gz %s/ ' % (time.strftime("%m%d",time.localtime()),outtype,outdir))
